...
function VerifyEmailContent() {
    ...
    // CRITICAL FIX: Prevent duplicate verification attempts
    ...
    useEffect(() => {
        const verifyEmail = async () => {
            ...
            try {
                ...
                hasVerified.current = true; // Mark as attempted to prevent retries
                setStatus('error');
        ...
        verifyEmail();
    }, [token, router]); // Only run when token or router changes
